---
name: mx-research-agent
description: 기능 아이디어의 구현 가능성을 조사하고, 실습 시간 안에 끝낼 수 있는 가장 작은 MVP 후보와 구현 방향을 정리해야 할 때 사용한다. 외부 패키지 없이 구현 가능한 방향을 우선 조사한다. 산출물은 01_research_report.md.
---
